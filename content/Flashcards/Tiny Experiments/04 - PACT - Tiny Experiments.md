...
# Questions
- [[04 - PACT - Tiny Experiments#myNotes|What are the main benefits of committing to a PACT?]]
# Summary
![[PACT - Tiny Experiments.svg]]

After collecting data on your [[03 - Field Notes - Tiny Experiments|Field Notes]], we can analyze them and find what experiments to commit on.
...
- **Output instead of Outcome**: You are focusing on what you are delivering instead of what the end result should look like: instead of saying I will run a marathon in 6 months (Typical of [[01 - Linear Goals - Tiny Experiments|Linear Goals]]), you can say, "I will run every second day". Instead of saying "I will write" a book, just try by writing every day 250 words.
